...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0;i<4;i++){                                   //utilizamos un ciclo for para poder instanciar los 4 hilos creadores
            Creador c = new Creador(i,tiempo_creador, inicial);
        ...
        for(int i=0; i<2; i++){                                                                //utilizamos un ciclo for para poder instanciar los 2 hilos revisores
            Revisor revisor = new Revisor(i,tiempo_revisor, inicial, validados);
            ...
            Consumidor consumidor = new Consumidor(i,tiempo_consumidor,validados, inicial);    //utilizamos un ciclo for para poder instanciar los 2 hilos consumidores
